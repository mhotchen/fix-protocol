...
object Test extends App {
  ...
  val test2 = "8=should be removed as duplicate|8=FIX.4.4|35=8|58=blah blah $%^*(=|".replace('|', 1.toChar)
  ...
  println("-- getting a specific tag's value")
  println(test1.messages.head.fields(Tag(8)))
}
